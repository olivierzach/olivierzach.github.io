...
GPipe gives the scaling-systems side of the list: training larger models by partitioning computation.

## Reading angle

- Focus on micro-batching and pipeline bubbles.
- Compare algorithmic architecture gains with systems scaling gains.
